...
function apiaiResponseFormat(speech,displayText,data, contextOut){
    console.log("SSwkresponse apiaiResponseFormat");
    return{
        "speech": speech,
        "display": displayText,
        "data": data,
            ...
            case "user_Evaluation":
                ...
                var options = { method: 'POST',
                    ...
                    {   userCode: 'pvqH9wZSRmbRGFhVKPtJGw==',
                        ...
                        clientCode: 'i7z9hO9MNrA4DBOJmF+Ykbo693dpPyH4mroJod3DnvUBclxOmWC2Lb4b5iragxZw',
                        answersXML: '<?xml version=\'1.0\'?><BasicQuestionnaireResult xmlns:xsi=\'http://www.w3.org/2001/XMLSchema-instance\' xmlns:xsd=\'http://www.w3.org/2001/XMLSchema\'>'+ans
                    }
                };
